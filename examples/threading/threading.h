...
struct thread_data{
     ...
     */
    // define wait_to_obtain_ms as the time required to wait before obtaining the mutex
    int wait_to_obtain_ms;
    // define wait_to_release_ms as the time required to wait before releasing the mutex
